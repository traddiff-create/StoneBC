...
### 1. Cleanup Supplies — $200

| Item | Qty | Est. Cost | Source | Purchased |
|------|-----|-----------|--------|-----------|
| Heavy-duty trash bags (33 gal) | 2 boxes | $20 | Sam's Club | [ ] |
| Clear recycling bags (33 gal) | 1 box | $10 | Sam's Club | [ ] |
| Work gloves (assorted S/M/L) | 20 pairs | $35 | Sam's Club | [ ] |
| Litter grabbers / pickup tools | 10 | $50 | Amazon (not at Sam's) | [ ] |
| High-vis safety vests | 15 | $25 | Amazon | [ ] |
| Hand sanitizer (pump) | 3 | $8 | Sam's Club | [ ] |
| Sunscreen (pump bottle) | 2 | $8 | Sam's Club | [ ] |
| First aid kit | 1 | $15 | Sam's Club | [ ] |
| Zip ties (bag attachment) | 1 pack | $5 | Sam's Club | [ ] |
| Sharps container | 1 | $4 | Walmart pharmacy | [ ] |
| **Subtotal** | | **~$180** | | |

**Buffer: $20** — covers price variance or extra supplies

**Buy by: April 25** (Sam's Club trip)
**Order Amazon items by: April 20** (grabbers + vests need shipping time)
...
| Item | Qty | Est. Cost | Source | Purchased |
|------|-----|-----------|--------|-----------|
| Color flyers (8.5x11) | 100 | $40 | Minuteman Press / Staples | [ ] |
| Posters (11x17 color) | 20 | $30 | Minuteman Press / Staples | [ ] |
...
### Trip 1: Amazon Order — by April 20
- [ ] Litter grabbers (10) — ~$50
- [ ] High-vis safety vests (15-pack) — ~$25
- [ ] Custom vinyl banner — ~$40 (needs design file)
- **Amazon total: ~$115**

### Trip 2: Sam's Club — week of April 21-25
- [ ] Trash bags, recycling bags
- [ ] Work gloves (bulk)
- [ ] Hand sanitizer, sunscreen
- [ ] First aid kit, zip ties
- [ ] Thank-you cards
- **Sam's Club total: ~$100**

### Trip 3: Print Shop — by April 21
- [ ] Flyers (100)
- [ ] Posters (20)
- [ ] Route maps (50)
- **Print total: ~$95**

### Trip 4: Sam's Club — May 1 (day before)
- [ ] Water, sports drinks
...
Every spend ties back to the three empathy pillars from the grant application:

| Spend | Pillar | How |
|-------|--------|-----|
| Cleanup supplies | Environmental stewardship | Cleaning bike corridors and public spaces |
| Event materials | Equitable access | Reaching ALL of Rapid City, not just cycling crowd |
| Food & snacks | Community connection | Post-ride gathering builds relationships |
| Social media | Equitable access | Boosted posts reach underserved neighborhoods |
| Feeding SD donation | Community connection | Grant money does double duty for RC neighbors |

---

## Receipt Tracking

Photo every receipt and save to `StoneBC/business-docs/receipts/`
Keep for AHA impact report (May 3-10).
...
| Date | Action |
|------|--------|
| **Apr 14-18** | Design flyer, banner, route map |
| **Apr 18** | Start social media ad boosts |
| **Apr 20** | Amazon order (grabbers, vests, banner) |
| **Apr 21** | Print flyers/posters/maps |
| **Apr 21-25** | Sam's Club trip #1 (supplies) |
| **Apr 25** | Begin distributing flyers to bike shops, coffee shops |
| **May 1** | Sam's Club trip #2 (food, perishables) |
| **May 2** | EVENT DAY |
| **May 3-10** | Impact report + Feeding SD donation |

---

*Created: 2026-04-14 | Grant funds: in transit to BHCB*
