...
data class TourGuide(
    ...
    val overlayDefaults: TourGuideOverlayDefaults? = null,
    val stopTags: List<String>? = null,
    val gearProfile: String? = null,
    val safetyNotes: List<String>? = null,
    val days: List<TourDay> = emptyList()
)

@Serializable
data class TourGuideOverlayDefaults(
