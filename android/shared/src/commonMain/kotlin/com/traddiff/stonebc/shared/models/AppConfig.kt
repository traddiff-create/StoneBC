...
data class AppConfig(
    ...
    data class Features(
        ...
        val enableRideAlerts: Boolean = false
    )

    @Serializable
    data class DataURLs(
        val wordpressBase: String? = null,
    ...
    data class ApiKeys(
        ...
        val garminClientId: String? = null,
        val wahooClientId: String? = null,
        val rideWithGPSClientId: String? = null,
